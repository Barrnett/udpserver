#ifndef LOCAL_CONTROLLER_LIST_H
#define LOCAL_CONTROLLER_LIST_H

#include <string>
using namespace std;
#include "../MXDatabase/NetElementDb.h"

class CLocalControllerList
{
public:
	CLocalControllerList();
	~CLocalControllerList();
